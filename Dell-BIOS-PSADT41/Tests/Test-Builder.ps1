...
'@
    ...
    Assert ($secondManifest.BuilderVersion -eq '4.2.0' -and $secondManifest.PackageType -eq 'BIOS' -and (Test-Path (Join-Path $second.SourcePath 'Files/UI/WindowChrome.ps1')) -and (Test-Path (Join-Path $second.SourcePath 'Files/UI/Theme.xaml'))) 'V4.2 BIOS packages retain shared custom caption and theme resources'
