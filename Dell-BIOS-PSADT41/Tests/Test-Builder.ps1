...
'@
    ...
    Assert ($secondManifest.BuilderVersion -eq '4.3.0' -and $secondManifest.PackageType -eq 'BIOS' -and (Test-Path (Join-Path $second.SourcePath 'Files/UI/WindowChrome.ps1')) -and (Test-Path (Join-Path $second.SourcePath 'Files/UI/Theme.xaml'))) 'V4.3 BIOS packages retain shared custom caption and theme resources'
