...
'@
    ...
    foreach ($version in @('4.0.0','4.1.8','4.2.0')) {
        ...
        Check ($manifest.BuilderVersion -eq '4.4.0' -and $manifest.PackageType -eq 'Application' -and $manifest.SourcePreserved) "$version records mode and source preservation"
