...
try {
    ...
    Check ($xml.DocumentElement.Title -eq 'PSADT Deployment Builder v5' -and (Import-PowerShellDataFile "$root/Builder/Branding.psd1").AppTitle -eq $xml.DocumentElement.Title) 'Default caption and branded title identify v4.5'
